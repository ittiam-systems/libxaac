...
static VOID ixheaace_read_drc_config_params(
  ...
  pstr_enc_params->delay_mode = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_uni_drc_config->sample_rate_present = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_uni_drc_config->str_drc_coefficients_uni_drc->drc_frame_size_present =
      fuzzed_data->ConsumeIntegral<WORD16>();
  pstr_uni_drc_config->loudness_info_set_present = fuzzed_data->ConsumeIntegral<WORD8>();

  pstr_uni_drc_config->drc_instructions_uni_drc_count = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  for (n = 0; n < pstr_uni_drc_config->drc_instructions_uni_drc_count; n++) {
    ...
    pstr_drc_instructions_uni_drc->additional_downmix_id_present =
    ...
    pstr_drc_instructions_uni_drc->depends_on_drc_set_present =
        fuzzed_data->ConsumeIntegral<WORD8>();
    pstr_drc_instructions_uni_drc->depends_on_drc_set = fuzzed_data->ConsumeIntegral<WORD8>();
    pstr_drc_instructions_uni_drc->no_independent_use = fuzzed_data->ConsumeIntegral<WORD8>();
    ...
    gain_set_channels = fuzzed_data->ConsumeIntegral<WORD8>();
    for (ch = 0; ch < 8; ch++) {
    ...
    pstr_drc_instructions_uni_drc->num_drc_channel_groups = fuzzed_data->ConsumeIntegral<WORD8>();
    ...
    pstr_drc_instructions_uni_drc->limiter_peak_target_present =
        fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  pstr_uni_drc_config->drc_coefficients_uni_drc_count = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  for (n = 0; n < pstr_uni_drc_config->drc_coefficients_uni_drc_count; n++) {
    ...
    pstr_drc_coefficients_uni_drc->gain_set_count = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  pstr_enc_loudness_info_set->loudness_info_count = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  pstr_enc_loudness_info_set->loudness_info_album_count = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  pstr_uni_drc_config->str_channel_layout.layout_signaling_present =
      fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  pstr_uni_drc_config->downmix_instructions_count = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_uni_drc_config->downmix_instructions_count =
      MIN(pstr_uni_drc_config->downmix_instructions_count, MAX_DOWNMIX_INSTRUCTION_COUNT);
  ...
  pstr_uni_drc_config->drc_description_basic_present = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_uni_drc_config->uni_drc_config_ext_present = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_enc_loudness_info_set->loudness_info_set_ext_present =
      fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_enc_gain_extension->uni_drc_gain_ext_present = fuzzed_data->ConsumeIntegral<WORD8>();
}
...
static VOID ixheaace_fuzzer_flag(ixheaace_input_config *pstr_in_cfg,
  ...
  pstr_in_cfg->i_use_mps = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->i_use_adts = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->i_use_es = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->aac_config.use_tns = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->aac_config.noise_filling = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  pstr_in_cfg->esbr_flag = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->aac_config.full_bandwidth = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  pstr_in_cfg->cplx_pred = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->usac_en = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->ccfl_idx = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->pvc_active = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->harmonic_sbr = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->hq_esbr = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->use_drc_element = fuzzed_data->ConsumeIntegral<WORD8>();
  pstr_in_cfg->inter_tes_active = fuzzed_data->ConsumeIntegral<WORD8>();
  ...
  if (pstr_in_cfg->use_drc_element == 1) {
    LOOPIDX k;
    {
      ...
      pstr_drc_cfg->str_enc_params.gain_sequence_present = 0;
      for (k = 0; k < pstr_drc_cfg->str_uni_drc_config.drc_coefficients_uni_drc_count; k++) {
        if (pstr_drc_cfg->str_uni_drc_config.str_drc_coefficients_uni_drc[k].drc_location == 1) {
          if (pstr_drc_cfg->str_uni_drc_config.str_drc_coefficients_uni_drc[k].gain_set_count >
              0) {
            pstr_drc_cfg->str_enc_params.gain_sequence_present = 1;
            break;
          }
        }
      }

      if (pstr_drc_cfg->str_enc_params.gain_sequence_present == 0) {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size) {
  ...
  memset(&str_enc_api, 0, sizeof(str_enc_api));
