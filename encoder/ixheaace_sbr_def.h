...
#define NO_OF_ESTIMATES_ELD_3 (3)
#define RELAXATION_FRACT (0.524288f)
#define SBR_NOISE_FLOOR_OFFSET_VALUE (0.09375f)
#define SBR_TON_MEAN_P0009_ELD (SBR_TON_MEAN_P0009 * RELAXATION)
#define SBR_TON_MEAN_101P59_ELD (SBR_TON_MEAN_101P59 * RELAXATION)
#define QUANT_VALUE (-0.03125f)
